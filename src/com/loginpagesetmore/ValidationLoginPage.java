...
public class ValidationLoginPage {
	...
	public void verifyElement() throws InterruptedException, InvalidFormatException, IOException {
		...
		page = PageFactory.initElements(setUpBrowser.driver, Loginpage.class);
	...
	public void verifyAndValidLoginPage() throws InvalidFormatException, IOException, InterruptedException {
		...
		for (int index = 0; index < file.testData.size(); index++) {
			...
			if(setUpBrowser.driver.findElements(By.xpath("//*[@id='headerNav']/h1")).size() != 0)
			{
				Thread.sleep(4000);
				...
				page.SignOutSetmore();
				String logoutURL = setUpBrowser.driver.getCurrentUrl();
